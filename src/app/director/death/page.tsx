            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div className="bg-white dark:bg-zinc-900 p-5 rounded-xl border border-primary/5 dark:border-slate-800 shadow-sm">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="size-8 rounded-lg bg-orange-100 dark:bg-orange-950/40 flex items-center justify-center text-orange-600 dark:text-orange-400">
                ...
                <div className="bg-white dark:bg-zinc-900 p-5 rounded-xl border border-primary/5 dark:border-slate-800 shadow-sm">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="size-8 rounded-lg bg-green-100 dark:bg-green-950/40 flex items-center justify-center text-green-600 dark:text-green-400">
