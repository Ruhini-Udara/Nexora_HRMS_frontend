...
import { Users, CalendarDays, Clock, Contact, Calendar, FileText, BarChart2 } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto w-full pt-20">
      ...
      <div className="mb-8 pt-2">
        ...
        <p className="text-gray-500 text-base">Welcome back! Here's what's happening in HR MATE today.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <StatCard 
          ...
          value="1,248" 
          subtext={<span className="text-green-600">↗ +12% from last month</span>}
