    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex flex-col">
            <div className="flex-1 p-8 max-w-7xl mx-auto w-full">
                                            ...
                                            <tr>
                                                <td colSpan={6} className="py-12 text-center text-slate-500">
                                                    <div className="flex flex-col items-center justify-center gap-2">
                                                        ...
                                                        <p>No verified requests pending batch creation.</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        )}
                ...
                {/* Stage 2: Management & Print Layout */}
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="border-b border-slate-200 dark:border-slate-700 print:border-slate-800 text-xs uppercase tracking-wider font-bold text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-800 print:text-black">
                                            ...
                                            <th className="py-4 px-6 print:py-2">Current Location</th>
                                            <th className="py-4 px-6 print:py-2">Target Location</th>
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
                        ...
                        <div className="p-6">
                            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                                You are about to submit <span className="font-bold text-slate-900 dark:text-white">{managementList.length}</span> request(s) for final board approval.
                            </p>
