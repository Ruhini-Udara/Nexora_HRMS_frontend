                                        ...
                                        <tr key={req.id} className="border-t border-gray-100 dark:border-slate-800 hover:bg-gray-50 dark:hover:bg-slate-800/40 transition-colors">
                                            ...
                                            <td className="py-4 px-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="font-semibold text-gray-800 dark:text-slate-200">{req.name}</p>
                                                        <p className="text-xs text-gray-400 dark:text-slate-500">{req.role}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            {/* Leave Type */}
                                            <td className="py-4 px-4 text-gray-600 dark:text-slate-400">{req.leaveType}</td>
                                            {/* Duration */}
                                            <td className="py-4 px-4 text-gray-600 dark:text-slate-400">{req.duration}</td>
                                            {/* Status */}
                                            <td className="py-4 px-4">
                                                <span
