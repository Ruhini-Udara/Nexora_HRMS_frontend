            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-3">
                    <div className="text-right">
                        <p className="text-sm font-semibold text-gray-800 dark:text-white">Supervisor Profile</p>
                        <p className="text-xs text-gray-500 dark:text-slate-400 font-medium">Operations Lead</p>
                    </div>
