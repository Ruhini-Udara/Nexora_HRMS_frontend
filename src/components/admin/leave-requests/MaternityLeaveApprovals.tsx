...
export default function MaternityLeaveApprovals() {
            ...
            cell: info => {
                ...
                return (
                    <span className={`inline-flex px-2.5 py-1 rounded-full text-xs font-semibold ${
                        status === "Branch Level Reviewed" ? "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400" :
                        status === "Submitted for Salary Calculation" ? "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400" :
    ...
    ], [filteredRequests, selectedRequests, handleToggleAll, handleToggleSelection]);
