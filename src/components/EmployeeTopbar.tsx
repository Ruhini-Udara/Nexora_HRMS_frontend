    ...
    <div className="flex items-center gap-4">
            ...
            <div className="p-4 border-b border-border-light dark:border-border-dark hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors relative">
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">Your leave request has been approved.</p>
      ...
      <Link href="/employee/settings" className="flex items-center gap-3 hover:bg-gray-50 dark:hover:bg-gray-800/50 p-2 rounded-lg transition-colors group cursor-pointer">
        <div className="text-right">
          <p className="text-sm font-semibold text-gray-900 dark:text-white leading-none group-hover:text-primary transition-colors">Tharindu Perera</p>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Employee</p>
        </div>
        <Image
          alt="Employee User Profile Picture"
          width={40}
          height={40}
          className="w-10 h-10 rounded-full object-cover ring-2 ring-primary group-hover:ring-offset-2 transition-all dark:ring-offset-gray-900 bg-slate-200"
