        ...
        <div className="flex items-center gap-4">
            ...
            <Link href="/hr/profile" className="flex items-center gap-3 hover:bg-gray-50 dark:hover:bg-gray-800/50 p-2 rounded-lg transition-colors group cursor-pointer">
                <div className="text-right">
                    <p className="text-sm font-semibold text-gray-900 dark:text-white leading-none group-hover:text-primary transition-colors">Sandun Gamage</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">HR User</p>
                </div>
                <Image
